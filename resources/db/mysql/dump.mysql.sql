...
CREATE TABLE IF NOT EXISTS `cms_users` (
  ...
  `role_id` SMALLINT(5) UNSIGNED NOT NULL COMMENT '',
  `password` VARCHAR(100) NOT NULL COMMENT '',
  `email` VARCHAR(150) NOT NULL COMMENT '',
  `name` VARCHAR(255) NOT NULL COMMENT '',
  `timezone` VARCHAR(50) NOT NULL COMMENT '',
  `created_on` DATETIME NOT NULL COMMENT '',
  `updated_on` DATETIME NOT NULL COMMENT '',
  `login_on` DATETIME NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  UNIQUE INDEX `email` USING BTREE (`email` ASC)  COMMENT '',
  INDEX `role_id` USING BTREE (`role_id` ASC)  COMMENT '')
ENGINE = MyISAM;
...
CREATE TABLE IF NOT EXISTS `sessions` (
  `session_key` CHAR(32) NOT NULL COMMENT '',
  `last_active` INT UNSIGNED NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `session_vars` (
  `session_key` CHAR(32) NOT NULL COMMENT '',
  `private_key` CHAR(32) NOT NULL COMMENT '',
  `name` VARCHAR(20) NOT NULL COMMENT '',
  `value` TEXT NULL COMMENT '',
  INDEX `session_key_idx` (`session_key` ASC)  COMMENT '',
  UNIQUE INDEX `session_value` (`private_key` ASC, `name` ASC, `session_key` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `cache` (
  `cache_key` CHAR(32) NOT NULL COMMENT '',
  `value` TEXT NOT NULL COMMENT '',
  `expire` INT(11) NOT NULL COMMENT '',
  PRIMARY KEY (`cache_key`)  COMMENT '')
ENGINE = MyISAM;
...
CREATE TABLE IF NOT EXISTS `cms_ownership` (
  `owner_id` INT UNSIGNED NOT NULL COMMENT '',
  `resource_id` INT UNSIGNED NOT NULL COMMENT '',
  `model` VARCHAR(48) NOT NULL COMMENT '',
  PRIMARY KEY (`owner_id`, `resource_id`, `model`)  COMMENT '',
  INDEX `owner` (`owner_id` ASC)  COMMENT '',
  INDEX `resource` (`resource_id` ASC)  COMMENT '')
ENGINE = MyISAM;
