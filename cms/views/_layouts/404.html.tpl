...
<head>
    ...
    {assets source=['vendor/components/bootstrap/css/bootstrap.css', 'cms/assets/css/bootstrap-theme.athlon.css', 'cms/assets/css/style.css'] media="all"}
        ...
        <div class="container">
          <div class="row">
             <div class="col-lg-12">
                 ...
                 <p class="text-thin"><a href="{link_to controller=account}" class="btn btn-outline btn-link btn-lg no-padding-left"><i class="glyphicon glyphicon-user"></i> {$_labels.modules.account.title}</a></p>
             </div>
          </div>
