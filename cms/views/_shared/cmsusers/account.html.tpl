<ul class="nav navbar-nav navbar-right navbar-user text-thin no-margin-right">
  <li class="dropdown user-dropdown">
    ...
    <ul class="dropdown-menu">
      ...
      <li class="divider"></li>
      <li>
        <a href="{link_to controller=account}"><i class="glyphicon glyphicon-user"></i> {$_labels.modules.account.index}
        </a>
      </li>
      {if {user_can controller=account action=credentials}}
        <li>
          <a href="{link_to controller=account action=credentials}"><i class="glyphicon glyphicon-lock"></i> {$_labels.modules.account.credentials}
          </a>
        </li>
      {/if}
      <li class="divider"></li>
      <li>
        <a href="{link_to controller=authentication action=logout}"><i class="glyphicon glyphicon-off"></i> {$_labels.sections.logout}
        </a>
      </li>
    </ul>
  </li>
