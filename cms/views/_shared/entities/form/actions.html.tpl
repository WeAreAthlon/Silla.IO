...
<div class="btn-group pull-right" role="toolbar">
    <button class="btn btn-outline btn-default navbar-btn cancel" type="reset"><span class="glyphicon glyphicon-menu-left"></span> {$_labels.buttons.cancel}</button>
    <button class="btn btn-outline btn-success navbar-btn" type="submit"><span class="glyphicon glyphicon-pencil"></span> {if $_action eq 'create'}{$_labels.buttons.create}{else}{$_labels.buttons.save}{/if}</button>
</div>
