        ...
        <div class="tab-pane {if $smarty.foreach.form_sections_contents.first} in active{/if}" id="form-section-{$section_key}">
            <fieldset data-section="{$section_key}">
                ...
                <div class="form-fields-wrapper">
                    {include file='_shared/entities/form/_fields.html.tpl' section=$section_key attributes=$section.fields|default:[] serialize=$section.meta.serialize|default:false}
                </div>
            </fieldset>
        </div>
    {/foreach}
