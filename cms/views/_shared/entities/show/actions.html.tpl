<div class="modal-footer no-padding-bottom">
    ...
    {if {user_can controller=$_controller action=delete}}
        <a href="{link_to controller=$_controller action=delete id={$resource->{$resource->primaryKeyField()}}}" class="btn btn-outline btn-danger action-delete" data-resource="{$resource->id}" data-controller="{$_controller}">
