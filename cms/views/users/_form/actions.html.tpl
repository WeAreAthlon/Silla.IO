{if $_action eq 'edit' and {user_can controller=$_controller action=delete} and not ($resource->id eq $user->id)}
...
<div class="btn-group pull-right" role="toolbar">
    <button class="btn btn-default navbar-btn cancel" type="reset">
