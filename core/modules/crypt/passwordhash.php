...
class PasswordHash
{
     ...
     * Init actions.
     *
     * @param integer $iterationCountLog2 Iteration count for log2.
     * @param mixed   $portableHashes     Portable hashes.
     */
     ...
     * Gets random bytes.
     *
     * @param integer $count Count number.
     *
     * @return string
     */
     ...
     * @param string $setting  Additional settings.
     *
     * @return string
     */
     ...
     * Hashing action.
     *
     * @param string $password Passphrase string.
     *
     * @return string
     */
     ...
     *
     * @param string $password    Passphrase string.
     * @param string $stored_hash Hash string.
     *
     * @return boolean
     */
